...
G_MODULE_EXPORT void linphone_gtk_start_call(GtkWidget *button);
void linphone_gtk_call_terminated();
G_MODULE_EXPORT void linphone_gtk_show_friends(void);
void linphone_gtk_show_contact(LinphoneFriend *lf);
void linphone_gtk_set_my_presence(LinphoneOnlineStatus ss);
G_MODULE_EXPORT void linphone_gtk_show_parameters(void);
...
G_MODULE_EXPORT void linphone_gtk_log_show(void);
...
G_MODULE_EXPORT void linphone_gtk_check_for_new_version(void);
...
G_MODULE_EXPORT void linphone_gtk_in_call_view_set_calling(LinphoneCall *call);
G_MODULE_EXPORT void linphone_gtk_in_call_view_set_in_call(LinphoneCall *call);
G_MODULE_EXPORT void linphone_gtk_in_call_view_update_duration(LinphoneCall *call);
G_MODULE_EXPORT void linphone_gtk_in_call_view_terminate(LinphoneCall *call, const char *error_msg);
G_MODULE_EXPORT void linphone_gtk_in_call_view_set_incoming(LinphoneCall *call);
G_MODULE_EXPORT void linphone_gtk_in_call_view_set_paused(LinphoneCall *call);
G_MODULE_EXPORT void linphone_gtk_mute_clicked(GtkButton *button);
G_MODULE_EXPORT void linphone_gtk_enable_mute_button(GtkButton *button, gboolean sensitive);
