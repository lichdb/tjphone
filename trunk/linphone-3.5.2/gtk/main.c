...
static GOptionEntry linphone_options[]={
	...
	},
	{
		...
		G_OPTION_ARG_STRING,
		&linphone_logfile,
		("path to a file to write logs into."),
		NULL
	},
	{
	    "configfile",
		...
		G_OPTION_ARG_STRING,
		&linphone_cfgfile,
		("path to the tjpphonerc config file."),
		NULL
	},
	{
		"iconified",
		...
		G_OPTION_ARG_NONE,
		(gpointer)&iconified,
		("Start only in the system tray, do not show the main interface."),
		NULL
	},
	{
	    "call",
	...
	},
	{
	    ...
	    ("if set automatically answer incoming calls"),
		NULL
	},
	{
	    "workdir",
	    ...
	    G_OPTION_ARG_STRING,
	    (gpointer) & workingdir,
	    ("Specifiy a working directory (should be the base of the installation, eg: c:\\Program Files\\Linphone)"),
		NULL
	},
	{0}
};
                   ...
                   int nCmdShow)
{
  ...
  return main (nArgs, (char **)szArglist);
}
#endif
...
int main(int argc, char *argv[]){
	...
	g_option_context_add_main_entries (context, linphone_options, NULL);
	...
	g_option_context_free(context);
	config_file=linphone_gtk_get_config_file(linphone_cfgfile);
