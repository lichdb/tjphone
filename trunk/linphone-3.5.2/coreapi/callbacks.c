...
static void call_received(SalOp *h){
	...
	bool_t propose_early_media;
	bool_t prevent_colliding_calls;
	const char *ringback_tone;
	propose_early_media=lp_config_get_int(lc->config,"sip","incoming_calls_early_media",FALSE);
	prevent_colliding_calls=lp_config_get_int(lc->config,"sip","prevent_colliding_calls",TRUE);
	ringback_tone=linphone_core_get_remote_ringback_tone (lc);
