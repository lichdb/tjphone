...
static LinphoneCoreVTable vtable={
	...
	linphone_gtk_display_question,
	linphone_gtk_call_log_updated,
	linphone_gtk_text_received,
	linphone_gtk_general_state,
	NULL,/*DtmfReceived dtmf_received*/
	linphone_gtk_refer_received,
	linphone_gtk_buddy_info_updated,
	NULL/*NotifyReceivedCb notify_recv;*/
};
#else
static LinphoneCoreVTable vtable={
...
#ifdef _MSC_VER
static GOptionEntry linphone_options[6];
#else
...
GtkWidget *linphone_gtk_create_window(const char *window_name){
	...
	GladeXML *gxml;
	char path[2048];
	snprintf(path,sizeof(path),"%s/%s.glade",INSTALLED_XML_DIR/*BUILD_TREE_XML_DIR*/,window_name);
/*
#ifdef WIN32
    if (_access(path,0) != -1) {
#else
...
G_MODULE_EXPORT
void about_url_clicked(GtkAboutDialog *dialog, const char *url, gpointer data){
...
int main(int argc, char *argv[]){
	...
	linphone_options[0].long_name = "verbose";
	linphone_options[0].short_name = '\0';
	linphone_options[0].arg = G_OPTION_ARG_NONE;
	linphone_options[0].arg_data = (gpointer)&verbose;
	linphone_options[0].description = N_("log to stdout some debug information while running.");
	linphone_options[0].arg_description = NULL;
	linphone_options[0].flags = 0;

	linphone_options[1].long_name ="iconified";
	linphone_options[1].short_name = '\0';
	linphone_options[1].arg = G_OPTION_ARG_NONE;
	linphone_options[1].arg_data = (gpointer)&iconified;
	linphone_options[1].description = N_("Start only in the system tray, do not show the main interface.");
	linphone_options[1].arg_description = NULL;
	linphone_options[1].flags = 0;

	linphone_options[2].long_name = "call";
	linphone_options[2].short_name = 'c';
	linphone_options[2].arg = G_OPTION_ARG_STRING;
	linphone_options[2].arg_data = &addr_to_call;
	linphone_options[2].description = N_("address to call right now");
	linphone_options[2].arg_description = NULL;
	linphone_options[2].flags = 0;
	
	linphone_options[3].long_name = "auto-answer";
	linphone_options[3].short_name = 'a';
	linphone_options[3].arg = G_OPTION_ARG_NONE;
	linphone_options[3].arg_data = (gpointer) & auto_answer;
	linphone_options[3].description = N_("if set automatically answer incoming calls");
	linphone_options[3].arg_description = NULL;
	linphone_options[3].flags = 0;

	linphone_options[4].long_name = "workdir";
	linphone_options[4].short_name = '\0';
	linphone_options[4].arg = G_OPTION_ARG_STRING;
	linphone_options[4].arg_data = (gpointer) & workingdir;
	linphone_options[4].description = N_("Specifiy a working directory (should be the base of the installation, eg: c:\\Program Files\\Linphone)");
	linphone_options[4].arg_description = NULL;
	linphone_options[4].flags = 0;

	linphone_options[5].long_name = '\0';
	linphone_options[5].short_name = '\0';
	linphone_options[5].arg = G_OPTION_ARG_NONE;
	linphone_options[5].arg_data = NULL;
	linphone_options[5].description = '\0';
	linphone_options[5].arg_description = NULL;
	linphone_options[5].flags = 0;
