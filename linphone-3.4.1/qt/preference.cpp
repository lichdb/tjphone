    ...
    ui(new Ui::Preference)
{
	...
	ui->spinBox_udp_sip_port->setValue(tr.udp_port);
	ui->spinBox_tcp_sip_port->setValue(tr.tcp_port);
...
void Preference::on_spinBox_udp_sip_port_valueChanged(int arg1)
{
    LCSipTransports tr;
...
void Preference::on_spinBox_tcp_sip_port_valueChanged(int arg1)
{
    LCSipTransports tr;
	LinphoneCore *lc=linphone_qt_get_core();
